        ...
        <div class="card" style="width: 24rem;">
            ...
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Kelas" class="form-control" id="Class" value="{{ $Student->kelas }}" aria-describedby="Class" >
                </div>
                <div class="form-group">
                    <label for="Major">Major</label>
                    <input type="text" name="Major" class="form-control" id="Major" value="{{ $Student->major }}" aria-describedby="Major" >
                </div>
